...
function TagTipo() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[76px]" data-name="tag-tipo">
      <div className="bg-[#a7b0b5] relative rounded-[8px] shrink-0 w-full" data-name="badge-text">
...
function CartaoLinha() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px relative" data-name="cartão-linha">
      <p className="flex-[1_0_0] font-['Open_Sans:Regular',sans-serif] font-normal leading-[1.4] min-h-px min-w-px relative text-[#a7b0b5] text-[14px] text-right" style={{ fontVariationSettings: "'wdth' 100" }}>
        Signature
      </p>
    </div>
  );
...
function Nome() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full" data-name="nome">
      <p className="font-['Open_Sans:Regular',sans-serif] font-normal leading-[1.3] relative shrink-0 text-[#a7b0b5] text-[16px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function CartaoNumero() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="cartão-número">
      <p className="font-['Open_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#a7b0b5] text-[16px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        •••• •••• •••• 5266
      </p>
    </div>
  );
...
function Paragraph() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="font-['Open_Sans:Regular',sans-serif] font-normal leading-[1.5px] relative shrink-0 text-[#a7b0b5] text-[12px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Validade
      </p>
    </div>
  );
...
function Card() {
  return (
    <div className="aspect-[320/200] relative rounded-[12px] shrink-0 w-full" data-name="card" style={{ backgroundImage: "linear-gradient(121.585deg, rgb(64, 76, 82) 0%, rgb(105, 117, 123) 105.77%)" }}>
      ...
      <div aria-hidden="true" className="absolute border border-[#404c52] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_4px_8px_0px_rgba(20,53,38,0.4)]" />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="content-stretch flex flex-col items-end justify-center relative size-full" data-name="02">
      <div className="content-stretch flex flex-col items-start max-h-[267.9310302734375px] max-w-[420px] min-h-[204.13792419433594px] min-w-[320px] p-[8px] relative shrink-0 w-[320px]" data-name="card-mockup">
        <Card />
      </div>
    </div>
  );
